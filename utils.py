...
def train_op_feddecor(model, loader, optimizer, epochs, lambda_fedprox=0.0, print_train_loss=False, feddecorr_coef = 0.05):
    model.train()
    ...
    for ep in range(epochs):
        for it, (x, y) in enumerate(loader):
            ...
            loss = loss + feddecorr_coef * loss_feddecorr
            if lambda_fedprox > 0.0:
